...
flags = tf.app.flags
flags.DEFINE_string("OPER_NAME", "Experiment_8_30_3", "name of experiments")
...
flags.DEFINE_float("weight_rotation_loss_g", 0.2, "weight for rotation loss for G")
flags.DEFINE_integer("num_rotation", 4, "0, 90, 180, 270")
flags.DEFINE_integer("loss_type", 2, "wgan:0; va: 1; -log(d(x)):2; 3: hinge loss")
flags.DEFINE_boolean("resnet", True, "whether using resnet architecture")
flags.DEFINE_boolean("is_adam", True, "using adam")
flags.DEFINE_boolean("ssup", True, "whether using self-supervised learning")
flags.DEFINE_integer("max_iters", 100000, "maxi iterations of networks")
flags.DEFINE_integer("batch_size", 8, "number of a batch")
...
flags.DEFINE_string("log_dir", "./output3/log/", "path of log")
flags.DEFINE_string("model_path", "./output3/model/", "path of model")
flags.DEFINE_string("sample_path", "./output3/sample/", "path of sample")
